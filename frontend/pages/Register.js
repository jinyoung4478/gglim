      ...
      <main class="register-container">
        <div class="register-wrapper">
            ...
            <form class="register-form">
                <div class="register-form__wrapper">
                    ...
                    <div class="register-form__wrapper-email">
                        <input type="email" class="register-input register-email" id="register-email" placeholder="이메일 계정" autocomplete="off" />
                        <button id="email-auth-button" class="register-input__button"  >인증하기</button>
                    </div>
                    <div id="register-email-confirm" class="register-form__wrapper-email">
                        <div class="register-form__wrapper-email">
                            <input type="text" maxlength="6" id="register-email-code" class="register-input register-email" placeholder="인증번호 입력" />
                ...
                <div class="register-form__wrapper">
                    ...
                    <div class="register-password-wrapper">
                        <input type="password" disabled class="register-input register-input-password" placeholder="비밀번호 입력" autocomplete="new-password" />
                        <input type="password" class="register-input register-input-password" placeholder="비밀번호 확인" autocomplete="new-password" />
                    </div>
                </div>
            ...
            <p class="register-login">
                이미 계정이 있나요?
                <a href="/login" class="register-login__highlight" data-link>로그인</a>
            </p>
        </div>
      </main>
        `;
